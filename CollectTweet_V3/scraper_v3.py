...
collectingDataSince = "2018-06-06"
collectingDataUntil = "2018-06-08"

### intial json file name
filename = 'top6-30_'+collectingDataSince+'_to_'+collectingDataUntil+'.json'
